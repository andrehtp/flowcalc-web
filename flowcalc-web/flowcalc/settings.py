"""
Django settings for flowcalc project.
...
ROOT_DIR = BASE_DIR.parent #voltar um nível para pegar o diretório raiz do projeto
...
WSGI_APPLICATION = 'flowcalc.wsgi.application'
